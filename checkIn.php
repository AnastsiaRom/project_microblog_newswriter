    ...
    <div class="container mt-4">
            <div class="row">
                <div class="col">
                    ...
                    <form action="authorization&check in/check.php" method="post">
                        ...
                        <table><tr><td><input type="text" name="chislo" id="chislo" placeholder="Число" class="chislo">+</td>
                        <td><input type="text" name="chislo_1" id="chislo_1" placeholder="Число" class="chislo">=</td>
                        <td><input type="text" name="summa" id="summa" placeholder="Сумма" class="chislo"></td></tr></table>
