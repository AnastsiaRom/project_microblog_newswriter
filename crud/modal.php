  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Редактировать пост <?=$value['id_post'] ?></h5>
      ...
      <div class="modal-body">
        <form action="?id_post=<?=$value['id_post'] ?>" method="post">
        	...
        	<div class="form-group">
        		<input type="text" class="form-control" name="edit_post_text" value="<?=$value['post_text'] ?>" placeholder="Текст поста">
        	</div>
...
<div class="modal fade" id="deleteModal<?=$value['id_post'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Удалить пост <?=$value['id_post'] ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
